...
def mode3():
    ...
    if change == 'username':
        ...
        if uchange == 'Amazon':
            ...
            usernames['Amazon'] = newu
            print(usernames['Amazon']," is now your new password")
        elif uchange == 'Mightyape':
            newu = input("What is the new username you would like to enter?: ")
            usernames['Mightyape'] = newu
            
        elif uchange == 'Google':
            newu = input("What is the new username you would like to enter?: ")
            usernames['Google'] = newu
        ...
        if pchange == 'Amazon':
            ...
            passwords['Amazon'] = newp
            print(passwords['Amazon'])
        elif pchange == 'Mightyape':
            newp = input("What is the new password you would like to enter?: ")
            passwords['Mightyape'] = newp
        elif pchange == 'Google':
            newp = input("What is the new password you would like to enter?: ")
            passwords['Google'] = newp
