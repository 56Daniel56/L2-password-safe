...
def mode2():
    ...
    newweb = 'addweb'
    newweb = {}
    newweb.append(addweb)
    newweb.append('Username: ' +adduse)
    newweb.append('Password: ' +addpass)
    print(newweb)
    return newweb;
...
def mode3():
    ...
    if change == 'username':
        ...
        if pchange == 'Amazon':
            ...
            del mightyape [2]
            newp = input("What is the new password you would like to enter?: ")
            mightyape.append('Password: '+newp)
            print(mightyape)
        elif pchange == 'Google':
            del google [2]
            newp = input("What is the new password you would like to enter?: ")
            google.append('Password: '+newp)
            print(google)
...
print("Daniel Herbert, 18th March 2019, Version 5 of Password safe.")
